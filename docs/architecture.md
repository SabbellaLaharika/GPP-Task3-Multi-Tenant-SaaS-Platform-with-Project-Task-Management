...
│  │                                                   │            │
│  │  ┌─────────────────────────────────────────┐    │            │
│  │  │  Tables (Multi-Tenant Shared Schema):   │    │            │
...
│  │  ┌─────────────────────────────────────────┐    │            │
│  │  │  Indexes (Performance):                 │    │            │
│  │  │  • tenant_id columns (B-tree)          │    │            │
│  │  │  • email columns (B-tree, unique)      │    │            │
│  │  │  • Foreign keys (automatic)            │    │            │
│  │  └─────────────────────────────────────────┘    │            │
│  │  ┌─────────────────────────────────────────┐    │            │
│  │  │  Constraints:                           │    │            │
│  │  │  • Foreign Keys with CASCADE DELETE    │    │            │
│  │  │  • Unique (tenant_id, email) for users │    │            │
...
│     role              VARCHAR │ (super_admin, tenant_admin, user)
...
│ FK  created_by        UUID    │ ───│──│ FK  project_id        UUID    │ ─┐
│     name              VARCHAR │    │  │ FK  created_by        UUID    │  │
│     description       TEXT    │    │  │ FK  assigned_to       UUID    │ ─┤
│     status            VARCHAR │    │  │     title             VARCHAR │  │
│     created_at        TIMESTAMP│   │  │     description       TEXT    │  │
│     updated_at        TIMESTAMP│   │  │     status            VARCHAR │  │
│                               │    │  │     priority          VARCHAR │  │
│ INDEX ON tenant_id            │    │  │     due_date          DATE    │  │
│ INDEX ON created_by           │    └──│     created_at        TIMESTAMP│ │
└───────────────────────────────┘       │     updated_at        TIMESTAMP│ │
                                         │                               │  │
                                         │ INDEX ON tenant_id            │  │
                                         │ INDEX ON project_id           │  │
